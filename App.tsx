...
const AdminControlPanel = ({ canchas, toggleCancha }: any) => {
  return (
    <div className="p-4 max-w-md mx-auto bg-slate-900 min-h-screen text-white pb-24">
      <h1 className="text-2xl font-bold mb-6 text-yellow-500 text-center uppercase tracking-widest">Panel de Control 🔒</h1>
        ...
        <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
          <nav className="bg-white/90 backdrop-blur-md border-b border-slate-200 sticky top-0 z-50 px-4 h-20 flex justify-between items-center">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold">Las Moras</span>
            </Link>
            <AdminAccessButton />
          </nav>
